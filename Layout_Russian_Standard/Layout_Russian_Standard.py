...
ek.appendKey( 20, mode, ",", ",_DELAY_ ")
ek.appendKey( 21, mode, "ch", "ch")
ek.appendKey( 22, mode, "c", "c")
ek.appendKey( 23, mode, "sel→", "_LEFT_SHIFT__RIGHT_ARROW__RELEASE_", 2)
...
ek.appendKey( 30, mode, "?", "_MODE1_?_DELAY_ ")
ek.appendKey( 31, mode, "word→", "_LEFT_CTRL__RIGHT_ARROW__RELEASE_", 2)

ek.appendKey( 32, mode, "r", "r")
ek.appendKey( 33, mode, "d", "d")
ek.appendKey( 34, mode, ".", "_MODE1_._DELAY_ ")
...
ek.appendKey( 43, mode, "sel↑", "_LEFT_SHIFT__UP_ARROW__RELEASE_", 2)
ek.appendKey( 44, mode, "the", "the")
ek.appendKey( 45, mode, " del", "_DELETE_", 2)
ek.appendKey( 46, mode, "sel↓", "_LEFT_SHIFT__DOWN_ARROW__RELEASE_", 2)
ek.appendKey( 47, mode, "copy", "_LEFT_CTRL_c_RELEASE_", 2)

ek.appendKey( 48, mode, "h", "h")
ek.appendKey( 49, mode, "f", "f")
ek.appendKey( 50, mode, "x", "x")
ek.appendKey( 51, mode, "!", "_MODE1_!_DELAY_ ")
ek.appendKey( 52, mode, '""', '""_DELAY__LEFT_ARROW_')
ek.appendKey( 53, mode, "#", "#")
ek.appendKey( 54, mode, "pgdn", "_PAGE_DOWN_", 2)
ek.appendKey( 55, mode, "selw→", "_LEFT_CTRL__LEFT_SHIFT__RIGHT_ARROW__RELEASE_", 2)

ek.appendKey( 56, mode, "space", " ", 2)
ek.appendKey( 57, mode, " ←  ", "_LEFT_ARROW_", 2)
ek.appendKey( 58, mode, "sel.←", "_LEFT_SHIFT__LEFT_ARROW__RELEASE_", 2)
ek.appendKey( 59, mode, "word←", "_LEFT_CTRL__LEFT_ARROW__RELEASE_", 2)
ek.appendKey( 60, mode, "home", "_HOME_", 2)
ek.appendKey( 61, mode, "paste", "_LEFT_CTRL_v_RELEASE_", 2)
ek.appendKey( 62, mode, "selw←", "_LEFT_CTRL__LEFT_SHIFT__LEFT_ARROW__RELEASE_", 2)
...
ek.appendKey( 20, mode, ";", "_MODE0_;_DELAY_ ")
...
ek.appendKey( 30, mode, "?", "?_DELAY_ ")
ek.appendKey( 31, mode, "word→", "_LEFT_CTRL__RIGHT_ARROW__RELEASE_", 2)

ek.appendKey( 32, mode, "R", "_MODE0_R")
ek.appendKey( 33, mode, "D", "_MODE0_D")
ek.appendKey( 34, mode, ":", "_MODE0_:_DELAY_ ")
ek.appendKey( 35, mode, "Z", "_MODE0_Z")
ek.appendKey( 36, mode, "  ↓ ", "_DOWN_ARROW_", 2)
ek.appendKey( 37, mode, "_", "_MODE0__")
...
ek.appendKey( 51, mode, "!", "!_DELAY_ ")
ek.appendKey( 52, mode, "'", "_MODE0_'")
ek.appendKey( 53, mode, "#", "_MODE3_#")
ek.appendKey( 54, mode, "pgdn", "_PAGE_DOWN_", 2)
ek.appendKey( 55, mode, "selw→", "_LEFT_CTRL__LEFT_SHIFT__RIGHT_ARROW__RELEASE_", 2)
...
ek.appendKey( 13, mode, "[]", "_MODE0_[]_DELAY__LEFT_ARROW_")
...
ek.appendKey( 21, mode, "{}", "_MODE0_{}_DELAY__LEFT_ARROW_")
...
ek.appendKey( 29, mode, "</>", "_MODE0_</>_DELAY__LEFT_ARROW__LEFT_ARROW_")
...
ek.appendKey( 40, mode, "esc ", "_ESC_", 2)
ek.appendKey( 41, mode, "SoftKbd", "_MODE0__DISABLE_", 2)
ek.appendKey( 42, mode, "`", "_MODE0_`")
ek.appendKey( 43, mode, "sel↑", "_LEFT_SHIFT__UP_ARROW__RELEASE_", 2)
ek.appendKey( 44, mode, "~", "_MODE0_~")
ek.appendKey( 45, mode, " del", "_DELETE_", 2)
ek.appendKey( 46, mode, "sel↓", "_LEFT_SHIFT__DOWN_ARROW__RELEASE_", 2)
ek.appendKey( 47, mode, " cut", "_MODE0__LEFT_CTRL_x_RELEASE_", 2)
...
ek.appendKey( 58, mode, "sel.←", "_LEFT_SHIFT__LEFT_ARROW__RELEASE_", 2)
ek.appendKey( 59, mode, "word←", "_LEFT_CTRL__LEFT_ARROW__RELEASE_", 2)
ek.appendKey( 60, mode, "top", "_MODE0__LEFT_CTRL__HOME__RELEASE_", 2)
ek.appendKey( 61, mode, "undo", "_MODE0__LEFT_CTRL_z_RELEASE_", 2)
ek.appendKey( 62, mode, "selw←", "_LEFT_CTRL__LEFT_SHIFT__LEFT_ARROW__RELEASE_", 2)
...
ek.appendKey(  5, mode, "()", "()_DELAY__LEFT_ARROW_")
ek.appendKey(  6, mode, "=", "=")
ek.appendKey(  7, mode, "backspace", "_BACKSPACE_", 2)
...
ek.appendKey( 13, mode, "[]", "[]_DELAY__LEFT_ARROW_")
...
ek.appendKey( 21, mode, "{}", "{}_DELAY__LEFT_ARROW_")
...
ek.appendKey( 29, mode, "</>", "</>_DELAY__LEFT_ARROW__LEFT_ARROW_")
...
ek.appendKey( 45, mode, " del", "_DELETE_", 2)
ek.appendKey( 46, mode, "sel↓", "_LEFT_SHIFT__DOWN_ARROW__RELEASE_", 2)
ek.appendKey( 47, mode, "copy", "_MODE0__LEFT_CTRL_c_RELEASE_", 2)
...
ek.appendKey( 59, mode, "word←", "_LEFT_CTRL__LEFT_ARROW__RELEASE_", 2)
ek.appendKey( 60, mode, "home", "_HOME_", 2)
ek.appendKey( 61, mode, "undo", "_LEFT_CTRL_z_RELEASE_", 2)
ek.appendKey( 62, mode, "selw←", "_LEFT_CTRL__LEFT_SHIFT__LEFT_ARROW__RELEASE_", 2)
...
ek.appendKey( 20, mode, ",", "_RUSLAT_,_DELAY_ _RUSLAT_")
ek.appendKey( 21, mode, "щ", "o_LEFT_ARROW__RIGHT_ARROW_")
ek.appendKey( 22, mode, "ц", "w")
ek.appendKey( 23, mode, "выд.→", "_LEFT_SHIFT__RIGHT_ARROW__RELEASE_", 2)
...
ek.appendKey( 30, mode, "?", "_MODE6_&_DELAY_ ")
ek.appendKey( 31, mode, "слово→", "_LEFT_CTRL__RIGHT_ARROW__RELEASE_", 2)

ek.appendKey( 32, mode, "р", "h")
ek.appendKey( 33, mode, "д", "l_LEFT_ARROW__RIGHT_ARROW_")  # double д is э
ek.appendKey( 34, mode, ".", "_MODE6_/_DELAY_ ")
...
ek.appendKey( 43, mode, "выд.↑", "_LEFT_SHIFT__UP_ARROW__RELEASE_", 2)
ek.appendKey( 44, mode, "ё", "`")
ek.appendKey( 45, mode, "удал.", "_DELETE_", 2)
ek.appendKey( 46, mode, "выд.↓", "_LEFT_SHIFT__DOWN_ARROW__RELEASE_", 2)
ek.appendKey( 47, mode, "копир.", "_RUSLAT__LEFT_CTRL_c_RELEASE__RUSLAT_", 2)

ek.appendKey( 48, mode, "ч", "x")
ek.appendKey( 49, mode, "ф", "a")
ek.appendKey( 50, mode, "х", "[")
ek.appendKey( 51, mode, "!", "_MODE6_!_DELAY_ ")
ek.appendKey( 52, mode, '""', '@@_DELAY__LEFT_ARROW_')
ek.appendKey( 53, mode, "№", "#")
ek.appendKey( 54, mode, "стр↓", "_PAGE_DOWN_", 2)
ek.appendKey( 55, mode, "в.сл.→", "_LEFT_CTRL__LEFT_SHIFT__RIGHT_ARROW__RELEASE_", 2)

ek.appendKey( 56, mode, "пробел", " ", 2)
ek.appendKey( 57, mode, " ←  ", "_LEFT_ARROW_", 2)
ek.appendKey( 58, mode, "выд.←", "_LEFT_SHIFT__LEFT_ARROW__RELEASE_", 2)
ek.appendKey( 59, mode, "слово←", "_LEFT_CTRL__LEFT_ARROW__RELEASE_", 2)
ek.appendKey( 60, mode, "начало", "_RUSLAT__HOME__RUSLAT_", 2)
ek.appendKey( 61, mode, "встав.", "_RUSLAT__LEFT_CTRL_v_RELEASE__RUSLAT_", 2)
ek.appendKey( 62, mode, "выд.с.←", "_LEFT_CTRL__LEFT_SHIFT__LEFT_ARROW__RELEASE_", 2)
...
ek.appendKey(  4, mode, "Л", "_MODE5_K_DELAY__LEFT_ARROW__RIGHT_ARROW_") # double k (л) is a ж (;:)
...
ek.appendKey( 14, mode, "Б", "_MODE5_<_DELAY__LEFT_ARROW__RIGHT_ARROW_")
ek.appendKey( 15, mode, "  → ", "_RIGHT_ARROW_", 2)
...
ek.appendKey( 21, mode, "Щ", "_MODE5_O_DELAY__LEFT_ARROW__RIGHT_ARROW_")
...
ek.appendKey( 34, mode, ":", "_MODE5__RUSLAT_:_DELAY_ _RUSLAT_")
ek.appendKey( 35, mode, "З", "_MODE5_P_LEFT_ARROW__RIGHT_ARROW_") # double з is ъ
ek.appendKey( 36, mode, "  ↓ ", "_DOWN_ARROW_", 2)
ek.appendKey( 37, mode, "_", "_MODE5__")
ek.appendKey( 38, mode, "К", "_MODE5_R")
ek.appendKey( 39, mode, "конец", "_END_", 2)

ek.appendKey( 40, mode, "Ы", "_MODE5_S")
ek.appendKey( 41, mode, "Ю", "_MODE5_>")
ek.appendKey( 42, mode, "Э", '_MODE5_"')
ek.appendKey( 43, mode, "выд.↑", "_LEFT_SHIFT__UP_ARROW__RELEASE_", 2)
ek.appendKey( 44, mode, "Ё", "_MODE5_~")
ek.appendKey( 45, mode, "удал.", "_DELETE_", 2)
ek.appendKey( 46, mode, "выд.↓", "_LEFT_SHIFT__DOWN_ARROW__RELEASE_", 2)
ek.appendKey( 47, mode, "вырез.", "_MODE5__RUSLAT__LEFT_CTRL_x_RELEASE__RUSLAT_", 2)
...
ek.appendKey(  5, mode, "()", "_MODE5_()_DELAY__LEFT_ARROW_")
...
ek.appendKey( 13, mode, "[]", "_MODE5__RUSLAT_[]_DELAY__LEFT_ARROW__RUSLAT_")
...
ek.appendKey( 21, mode, "{}", "_MODE5__RUSLAT_{}_DELAY__LEFT_ARROW__RUSLAT_")
...
ek.appendKey( 40, mode, "Выход", "_ESC_", 2)
ek.appendKey( 41, mode, "СофтКбд", "_MODE5__DISABLE_", 2)
ek.appendKey( 42, mode, "неопр.", "", 2)
ek.appendKey( 43, mode, "выд.↑", "_LEFT_SHIFT__UP_ARROW__RELEASE_", 2)
...
ek.appendKey( 54, mode, "pgdn", "_PAGE_DOWN_", 2)
ek.appendKey( 55, mode, "selw→", "_LEFT_CTRL__LEFT_SHIFT__RIGHT_ARROW__RELEASE_")

ek.appendKey( 56, mode, "таб ", "_MODE5__TAB_", 2)
ek.appendKey( 57, mode, " ←  ", "_LEFT_ARROW_", 2)
ek.appendKey( 58, mode, "выд.←", "_LEFT_SHIFT__LEFT_ARROW__RELEASE_", 2)
ek.appendKey( 59, mode, "слово←", "_LEFT_CTRL__LEFT_ARROW__RELEASE_", 2)
ek.appendKey( 60, mode, "нач.текс.", "_MODE5__RUSLAT__LEFT_CTRL__HOME__RELEASE__RUSLAT_", 2)
ek.appendKey( 61, mode, "отмена", "_MODE5__RUSLAT__LEFT_CTRL_z_RELEASE__RUSLAT_", 2)
ek.appendKey( 62, mode, "в.сл.←", "_LEFT_CTRL__LEFT_SHIFT__LEFT_ARROW__RELEASE_", 2)
...
ek.appendKey( 11, mode, "-", "-")
ek.appendKey( 12, mode, "%", "%")
ek.appendKey( 13, mode, "[]", "_RUSLAT_[]_DELAY__LEFT_ARROW__RUSLAT_")
...
ek.appendKey( 21, mode, "{}", "_RUSLAT_{}_DELAY__LEFT_ARROW__RUSLAT_")
...
ek.appendKey( 27, mode, "pgup", "_PAGE_UP_", 2)
ek.appendKey( 28, mode,  "9", "9")
ek.appendKey( 29, mode, "</>", "_RUSLAT_</>_DELAY__RUSLAT__LEFT_ARROW__LEFT_ARROW_")
ek.appendKey( 30, mode, "$", "$")
ek.appendKey( 31, mode, "word→", "_LEFT_CTRL__RIGHT_ARROW__RELEASE_", 2)
...
ek.appendKey( 54, mode, "стр↓", "_PAGE_DOWN_", 2)
ek.appendKey( 55, mode, "в.сл.→", "_LEFT_CTRL__LEFT_SHIFT__RIGHT_ARROW__RELEASE_")
...
ek.appendKey( 59, mode, "слово←", "_LEFT_CTRL__LEFT_ARROW__RELEASE_", 2)
ek.appendKey( 60, mode, "начало", "_RUSLAT__HOME__RUSLAT_", 2)
ek.appendKey( 61, mode, "отмена", "_RUSLAT__LEFT_CTRL_z_RELEASE__RUSLAT_", 2)
ek.appendKey( 62, mode, "в.сл.←", "_LEFT_CTRL__LEFT_SHIFT__LEFT_ARROW__RELEASE_", 2)
ek.appendKey( 63, mode, "→LAT", "_RUSLAT__MODE4_", 2)

f = open( "keymapRusStandard.h", "wt", encoding="UTF-8")
s = "{:s}".format(str(ek))
print(s)
f.write(s)
f.close()

f = open( "./Layout_Russian_Standard/StandardRussian.def", "wb")
if True:
