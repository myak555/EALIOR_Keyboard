...
# # right buttons = 5
# ek.appendKeySimple( 40, "y", "y", "ы", "s", ")", ")")
# ek.appendKeyFull( 41, "you", "you", "You", "_MODE0_You", "YOU", "YOU", "undef", "_MODE0_]", "undef", "]",
#                     "ю", ".", "Ю", "_MODE5_>", "Ю", ">", "неопр", "_MODE5_]", "неопр", "]")
# ek.appendKeyFull( 42, "th", "th", "Th", "_MODE0_Th", "TH", "TH", "`", "_MODE0_`", "`", "`",
#                     "э", "'", "Э", '_MODE5_"', "Э", '"', "неопр", "_MODE5_}", "неопр", "}")
# ek.appendKeyAllModes( 43, "sel↑", "выд.↑", "_LEFT_SHIFT__UP_ARROW__RIGHT_SHIFT_", 2)
# ek.appendKeyFull( 44, "the", "the", "The", "_MODE0_The ", "THE", "THE ", "~", "_MODE0_~", "~", "~",
#                     "ё", "`", "Ё", "_MODE5_~", "Ё", "~", "~", "_MODE5__RUSLAT_~_RUSLAT_", "~", "_RUSLAT_~_RUSLAT_")
# ek.appendKeyFull( 45, " del", "_DELETE_", " del", "_DELETE_", " del", "_DELETE_", " ins", "_MODE0__INSERT_", " del", "_DELETE_",
#                     "удал.", "_DELETE_", "удал.", "_DELETE_", "удал.", "_DELETE_", "встав.", "_MODE5__INSERT_", "удал.", "_DELETE_",
#                     [2,2,2,2,2,2,2,2,2,2])
# ek.appendKeyAllModes( 46, "sel↓", "выд.↓", "_LEFT_SHIFT__DOWN_ARROW__RIGHT_SHIFT_", 2)
# ek.appendKeyFull( 47, "copy", "_LEFT_CTRL_c_RIGHT_CTRL_", "cut", "_MODE0__LEFT_CTRL_x_RIGHT_CTRL_", "copy", "_LEFT_CTRL_c_RIGHT_CTRL_",
#                     "cut", "_MODE0__LEFT_CTRL_x_RIGHT_CTRL_", "copy", "_LEFT_CTRL_c_RIGHT_CTRL_",
#                     "копир.", "_RUSLAT__LEFT_CTRL_c_RIGHT_CTRL__RUSLAT_", "вырез.", "_MODE5__RUSLAT__LEFT_CTRL_x_RIGHT_CTRL__RUSLAT_",
#                     "копир.", "_RUSLAT__LEFT_CTRL_c_RIGHT_CTRL__RUSLAT_",
#                     "вырез.", "_RUSLAT__MODE5__LEFT_CTRL_x_RIGHT_CTRL__RUSLAT_", "копир.", "_RUSLAT__LEFT_CTRL_c_RIGHT_CTRL__RUSLAT_",
#                     [2,2,2,2,2,2,2,2,2,2])
...
# ek.appendKey( 40, mode, "e", "e")
# ek.appendKey( 41, mode, "a", "a")
# ek.appendKey( 42, mode, "t", "t")
# ek.appendKey( 43, mode, "t", "t")
# ek.appendKey( 44, mode, "t", "t")
# ek.appendKey( 45, mode, "t", "t")
# ek.appendKey( 46, mode, "t", "t")
# ek.appendKey( 47, mode, "t", "t")
